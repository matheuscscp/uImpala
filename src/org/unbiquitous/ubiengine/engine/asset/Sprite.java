...
public class Sprite {
  ...
  public void render(Sprite other) {
    render(other, 0, 0, false);
  }

  public void render(Sprite other, int x, int y, boolean center) {
  ...
  public void render(Text other) {
    render(other, 0, 0, false);
  }

  public void render(Text other, int x, int y, boolean center) {
